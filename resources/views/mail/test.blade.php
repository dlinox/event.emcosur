														...
														<tr>
															<td class="pad">
																<div style="color:#201f42;direction:ltr;font-family:Inter, sans-serif;font-size:18px;font-weight:400;letter-spacing:0px;line-height:180%;text-align:left;mso-line-height-alt:32.4px;">
																	...
																	<p style="margin: 0; margin-bottom: 0px;">Fecha: [Fecha]</p>
																	<p style="margin: 0;">Tribuna: [ ]&nbsp; - [ ]</p>
																</div>
															</td>
														</tr>
													</table>
													<table class="image_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 175px;"><img src="https://2ab0a24954.imgdist.com/public/users/Integrators/BeeProAgency/1139958_1125583/qr_code_barcode.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="175"></div>
																</div>
															</td>
														</tr>
													</table>
